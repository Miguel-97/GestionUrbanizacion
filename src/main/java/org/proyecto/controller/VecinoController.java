		...
		try {
			...
			if(v.getEstado().equals("inactivo")) {
				...
				String mensaje = "¡Hola vecino!\n"
						...
						+ "           Usuario: " + v.getEmail() + "           Contraseña: " + v.getPassword() + "\n\n"
